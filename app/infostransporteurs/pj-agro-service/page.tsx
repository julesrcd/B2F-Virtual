        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 flex gap-10 items-start">
          ...
          <div className="w-2/3">
            <p className="text-lg leading-8 mb-6">
              <strong>PJ Agro</strong> est l'une des filliales de PJ Group. Situé à Quintin (22), l'entreprise gère le stockage de produits agricoles (céréales/phytosanitaires/paille).
            </p>

            <p className="text-lg leading-8 mb-6">
             Nous stockons également de la plaquettes de bois pour notre client principal Breizh Pellet à Saint Brieuc.
            </p>

            <p className="text-lg leading-8 mb-6">
              Nous ne disposons pas de notre propre moyen de transports, mais nous faisons appel principalement à la fillilale PJ Transport également partenaire de PJ Group.
            </p>

            <p className="text-lg leading-8 mb-6">
              Nous pouvons également faire appel à des confrères de la bourse de fret B2F. 
            </p>
