        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 flex gap-10 items-start">
          ...
          <div className="w-2/3">
            <p className="text-lg leading-8 mb-6">
              <strong>Transport Raphael PELLERIN</strong> est une entreprise de transport créer en 2021 et situé à Paluel près de Le Havre. 
            </p>

            <p className="text-lg leading-8 mb-6">
             Notre activitée principal est le transport de fret en température dirigée ou en sec ainsi que le transport en vrac via un fond mouvant et plus récemment le transport de conteneur maritime. 
            </p>

            <p className="text-lg leading-8 mb-6">
             Pour ceci notre parc se constitue d’un scania R650 v8, un scania R590 v8 et un volvo Fh3 mais aussi de 2 bizien, une schmitz, un fond mouvant knapen et un châssis porte conteneur broshuis combi trailer.
            </p>
